...
export const Group = () => {
    ...
    const columns = useMemo<ColumnDef<GroupGridDto, any>[]>(
        () => [
            {
    ...
    return (
        <>
            <PageTitle>{t('Modules.Groups')}</PageTitle>
            <FormProvider {...methods}>
                <QueryRequestProvider
                    ...
                    queryKey='Groups'
                >
                    <QueryResponseProvider queryFn={useGroups} queryKey='Groups'>

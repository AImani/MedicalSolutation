...
export const createMedicalDocumentSchema = yup.object<CreateMedicalDocumentDto>().shape({
    ...
    GroupId: yup.number().required('شناسه بیمار الزامی است').typeError('شناسه بیمار باید عدد باشد'),
});
...
export const createGroupSchema = yup.object().shape({
    ...
    GroupStatusId: yup.number().required('وضعیت بیمار الزامی است').typeError('وضعیت بیمار باید عدد باشد'),

                    ...
                    <Card.Body className='p-5'>
                        <Row className='w-100 my-3 mx-0 me-auto'>
                            ...
                            <Col xs={'auto'} className='pt-5 mt-2'>
                                <InputGroup size='sm'>
                                    {canReject && <Button type='button' variant='danger' onClick={showReject}>
                                        <KTIcon iconName='cross-square' iconType='solid' className='fs-2 me-2' /> {t('Actions.Reject')}
                                    </Button>}
                                    {canApprove && <Button type='button' variant='success' onClick={showApprove}>
                                        <KTIcon iconName='check-square' iconType='solid' className='fs-2 me-2' /> {t('Actions.Approve')}
                                    </Button>}
                                    {canWaitingForApprove &&
                                        <Button type='button' variant='success' onClick={showWaitingForApprove}>
                                            <KTIcon iconName='check-square' iconType='solid' className='fs-2 me-2' /> {t('Actions.WaitingForApprove')}
                                        </Button>
                                    }
                                </InputGroup>
                            </Col>

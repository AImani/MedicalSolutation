...
const CardsWidget7 = ({className, description, stats, labelColor, textColor}: Props) => (
  <div className={`card card-flush ${className}`}>
    ...
    <div className='card-body d-flex flex-column justify-content-end pe-0 pt-0'>
      <span className='fs-6 fw-bolder text-gray-800 d-block mb-2'>بهترین همکاران امروز</span>
